package com.example.portfoliowebsite.config;
...
public class GraphiteConfiguration {
    ...
    public GraphiteMeterRegistry graphiteMeterRegistry() {
        ...
        GraphiteConfig config = new GraphiteConfig() {
            ...
            @Override
            public String host() {
                // Kept host.docker.internal to allow your containerized app
                // to communicate seamlessly with your local Graphite container
